...
clean_frequency(biden_clean) +
  labs(title = "Word Frequency",
       subtitle = "Tweets Containing Joe Biden",
       x = NULL,
       y = "Word count")
...
wordcloud(words = biden_clean$text, min.freq = 1,
          max.words = 200, random.order = FALSE, rot.per= 0.35, 
...
biden_sent <- sentiment_score(biden_clean)
...
biden_plot <- sentiment_plot(biden_sent) +
  labs(x = "Sentiment", 
       y = "Density", 
       title = "Joe Biden",
       subtitle = "The Distribution of Sentiment Scores") +
...
## Polarity score: using SentiWordNet word list
...
biden_polar <- polarity_score(biden_clean)
...
bernie_plot_polar <- polarity_plot(bernie_polar) +
  labs(x = "Sentiment", 
       y = "Density", 
       title = "Bernie Sanders",
       subtitle = "The Distribution of WordSentiNet Scores") +
  theme(plot.title = element_text(hjust = 0.5),
        plot.subtitle = element_text(hjust = 0.5),
        axis.text.y=element_blank())
...
biden_plot_polar <- polarity_plot(biden_polar) +
  labs(x = "Sentiment", 
       y = "Density", 
       title = "Joe Biden",
       subtitle = "The Distribution of WordSentiNet Scores") +
